...
declare namespace ts {
    ...
    function createPropertyAccessChain(expression: Expression, adjectiveDotToken: AdjectiveDotToken | undefined, name: string | Identifier): PropertyAccessChain;
    ...
    function createElementAccessChain(expression: Expression, adjectiveDotToken: AdjectiveDotToken | undefined, index: number | Expression): ElementAccessChain;
